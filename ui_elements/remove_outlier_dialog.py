...
class Ui_RemoveOutlierDialog(object):
    def setupUi(self, RemoveOutlierDialog):
        ...
        self.layoutWidget = QWidget(RemoveOutlierDialog)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(50, 20, 329, 227))
        ...
        self.lineEdit_maxMagField = QLineEdit(self.layoutWidget)
        ...
        self.lineEdit_minMagField = QLineEdit(self.layoutWidget)
        ...
        self.lineEdit_maxLongVal = QLineEdit(self.layoutWidget)
        ...
        self.lineEdit_minLongVal = QLineEdit(self.layoutWidget)
        ...
        self.lineEdit_maxLatVal = QLineEdit(self.layoutWidget)
        ...
        self.lineEdit_minLatVal = QLineEdit(self.layoutWidget)
