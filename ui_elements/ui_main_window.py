...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/search-icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.menuView.addAction(self.actionTimeseries_representation)
        self.menuView.addAction(self.actionDownward_continuation)
