...
If both requirement are meet, the user can open a file dialogue through the dropdown menu \verb|File| (see Fig.~\ref{fig:dropdown_import}).
...
The scissor tool \inlinegraphics{./../../src/ui_elements/icons/cut-scissor-icon.png} is designed to remove these intervals form the time-series.
...
This can be achieved by clicking again on \inlinegraphics{./../../src/ui_elements/icons/area-chart-icon.png}.
\begin{figure}
	\centering
	...
	\caption{
		...
		The \inlinegraphics{./../../src/ui_elements/icons/cut-scissor-icon.png} allows to remove an interval of undesired data points, configured as red rectangle.}
...
\begin{figure}
	...
	\caption{
		A cleaned time-series using the \inlinegraphics{./../../src/ui_elements/icons/cut-scissor-icon.png} tool as depicted in Fig.~\ref{fig:scissorInterval}.
	}
...
This can be achieved upon selecting \inlinegraphics{./../../src/ui_elements/icons/drawingIcon.png}.
...
Those can be removed using the the scissor tool \inlinegraphics{./../../src/ui_elements/icons/cut-scissor-icon.png}.
Upon, activation the user can lasso-select an arbitrary set of points which will be removed.
The lasso is controlled by the user drawing a free-hand curve through left-clicking desired points on the map and subsequent closed upon deselecting \inlinegraphics{./../../src/ui_elements/icons/cut-scissor-icon.png} again.
...
\end{figure}
For a more fine selection, a polynomial select tool \inlinegraphics{./../../src/ui_elements/icons/object-select-icon.png} is provided.
...
\begin{figure}
	...
	\caption{
		\inlinegraphics{./../../src/ui_elements/icons/object-select-icon.png} allows to clip a desired region using a polygon. The clipped region will be used for further processing and export.
	}
...
\begin{figure}
	...
	\caption{
		A zoomed view on the clipped region using the \inlinegraphics{./../../src/ui_elements/icons/object-select-icon.png} as indicated in Fig.~\ref{fig:polySelect}.
	}
...
To save the current project, select {\em Save Project} within the drop-down menu {\em File} (see Fig.\ref{fig:drowdown_import}).
This will open a file dialogue.
Within the file dialogue navigate to the desired location.
The location should be an empty folder which could be arbitrary named.
Within this folder the following will be created:
\begin{itemize}
	\item A \verb|project_name|.json file containing the project structure and meta information. 
	\item A folder for each survey containing all associated survey frames as parquet. 
\end{itemize}



\subsubsection{Loading a project}
To load a project, select {\em Load Project} within the drop-down menu {\em File} (see Fig.\ref{fig:drowdown_import}).
This will open a file dialogue.
Within the file dialogue navigate to the folder where the desired project was stored and select the corresponding \verb|*.json| file.
